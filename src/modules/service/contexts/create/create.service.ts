...
export class CreateServiceService {
  constructor(private serviceRepository: ServiceRepository, private planRepository: PlanRepository) { }

  async execute(data: CreateServiceRequestDTO, user: IAccessToken): Promise<ServiceDTO> {
    ...
    const currentAmoutOfServices = await this.serviceRepository.countServicesByBusiness(user.businessId);
