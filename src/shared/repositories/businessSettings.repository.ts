...
export class BusinessSettingsRepository {
    ...
    async save(businessSettings: Partial<BusinessSettings>): Promise<BusinessSettings> {
    ...
    async list(page: number, size: number): Promise<IPageResponse<BusinessSettings>> {
